CREATE DATABASE  IF NOT EXISTS `jukebox` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `jukebox`;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `SP_DropWholeJukebox` */;
...
BEGIN
	...
	SELECT GROUP_CONCAT(table_schema, '.', table_name) INTO @tables
	  ...
	  WHERE table_schema = 'jukebox'; -- specify DB name here.
...
-- Dump completed on 2015-04-21 11:26:15
